...
uint64_t fastcsum_nofold_vec256_align(const uint8_t *b, size_t size, uint64_t initial) {
    ...
    while (size >= 256) {
        u32x8 v1, c1;
        v1 = *(u32x8 *)(b);
        addc_minus1_vec(v1, c1, v1, *(u32x8 *)(b + 32));

        u32x8 v2, c2;
        v2 = *(u32x8 *)(b + 64);
        addc_minus1_vec(v2, c2, v2, *(u32x8 *)(b + 96));

        u32x8 v3, c3;
        v3 = *(u32x8 *)(b + 128);
        addc_minus1_vec(v3, c3, v3, *(u32x8 *)(b + 160));

        u32x8 v4, c4;
        v4 = *(u32x8 *)(b + 192);
        addc_minus1_vec(v4, c4, v4, *(u32x8 *)(b + 224));
    ...
    if (size >= 32) {
        u32x8 c;
        addc_minus1_vec(vac, c, vac, *(u32x8 *)(b));
        vac += c;
        vac += 1;
